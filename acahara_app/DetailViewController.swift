...
//        scrollView.contentOffset.x = scrollView.scrollView.contentOffset
    ...
    func didClickImageView(recognizer: UIGestureRecognizer) {
        if let imageView = recognizer.view as? UIImageView {
            ...
            let nextViewController =  UIStoryboard(name: "Main",bundle: nil).instantiateViewControllerWithIdentifier("PictureViewController") as! PictureViewController
            
            nextViewController.postSelectedIndex = dtSelectedIndex
            nextViewController.picSelectedIndex = imageView.tag
